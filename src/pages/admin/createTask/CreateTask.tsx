        ...
        <div className={styles.block}>
          <div className={styles.taskName_descriptionTask}>
            <div className={styles.taskName}>
              ...
              {formik.touched.taskName && formik.errors.taskName ? <div className={styles.errors}>{formik.errors.taskName}</div> : null}
          ...
          <div className={styles.strAnswers}>
            {answer.map(el => <div key={el.id} className={styles.newAnswerElement}>
              ...
              <div>
                {!el.value ? <div className={styles.errors}>{'2 field must be required!'}</div> : null}
                {answer.every(el => !el.checked) && (
                  <div className={styles.errors}>{'There must be at least 1 correct answer!'}</div>
                )}
              </div>
            </div>)}
